...
export function OverviewRightSidebar({
  ...
  return (
    <div
      className={cn(
        "fixed right-0 top-0 h-full bg-background border-l border-border shadow-2xl transition-all duration-300 z-30",
        isCollapsed ? "w-0 opacity-0" : "w-[500px] opacity-100"
      )}
    >
      {/* Header */}
